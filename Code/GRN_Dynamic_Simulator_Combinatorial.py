...
def ParametersInitiations():
    ...
    LogicGates = LogicGatesString2Matrix_Expanded('0123456701234567012345670123456701234567012345670123456701234561')
...
for Global_i in range(0, len(WTTP)):
    ...
    print(GetAttractorDistance(WTTP[str(Global_i)][1], np.array((Average_level)), TranscriptionPofileMax))
    print('\n')
