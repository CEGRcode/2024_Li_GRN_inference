...
echo "Step 0: Downloading processed data from Rossi 2019..."
git clone https://github.com/CEGRcode/2021-Rossi_Nature.git ./data/2021-Rossi_Nature

echo "Step 1: Processing the supplementary table 3 from Rossi 2019..."
